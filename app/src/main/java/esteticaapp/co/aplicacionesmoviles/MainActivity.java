...
public class MainActivity extends AppCompatActivity {
    ...
    FirebaseRecyclerAdapter<Persona,PersonaViewHolder.ViewHolder> adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new FirebaseRecyclerAdapter<Persona, PersonaViewHolder.ViewHolder>(
                Persona.class,
            ...
            protected void populateViewHolder(PersonaViewHolder.ViewHolder viewHolder,
                                              Persona model, final int position) {
